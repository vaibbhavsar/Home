...
public class DashboardFragment extends Fragment {
    ...
    private ArrayList<Contact> contactModels = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setDummyList();
        setRecyclerView(view,contactModels);
    ...
    private void setDummyList() {
        ...
        for(int i=0;i<20;i++)
        {
            mContact.set_status(true+"");
            mContact.setEmail("vvv@asd.com");
            mContact.setID(i);
            mContact.setName(i+"name");
            mContact.setPhoneNumber(i+"name");
            mContact.setSelected(false);

            contactModels.add(mContact);
